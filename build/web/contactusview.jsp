                ...
                <div>
                    ...
                    <div class="nav__list">
                        <div class="nav__items">
                            ...
                            <a href="contactusview.jsp" class="nav__link active">
        ...
        <%
            ...
            if("valid".equals(delete)){
                ...
                <div style="text-align: center">
                    <span style="color: red;font-size: 22px">Message Deleted Successfully!!</span>
                </div>
                <%
            }
        %>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="edit-delete">
                        <a href="mailto:<%=rs.getString("Email")%>" class="edit-btn">Message</a>  
                        <a href="contactusdelete.jsp?contactdelete=<%=rs.getString("Id")%>" class="delete-btn">Delete</a>  
                    </td>
                </tr>
                <%
                    }
