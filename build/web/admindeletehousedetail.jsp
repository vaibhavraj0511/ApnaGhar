        ...
        <%
            ...
            if("valid".equals(delete)){
                ...
                <div style="text-align: center">
                    <span style="color: red;font-size: 22px">Property Deleted Successfully!!</span>
                </div>
                <%
            }
        %>
        ...
        <table>
            ...
            <tbody>
                <%                                       
                    ...
                    ResultSet rs = null;
                    ps = con.prepareStatement("select * from addhouse");
                    rs = ps.executeQuery();
                ...
                <tr>
                    ...
                    <td>
                        <img src="<%=rs.getString("filename")%>" alt="No Image" style="width: 100px;height: 100px">
                    </td>
                    <td class="edit-delete">
                        <a href="adminhousedelete.jsp?housedelete=<%=rs.getString("id")%>" class="delete-btn">Delete</a>  
                    </td>
                </tr>
                <%
                    }
