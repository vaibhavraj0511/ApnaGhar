...
<html lang="en">
    ...
    <body>
                ...
                <div>
                    ...
                    <div class="nav__list">
                        <div class="nav__items">
                            ...
                            <a href="adminviewhouse.jsp" class="nav__link active">
                            ...
                            <!--<div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="girlsviewhouses.jsp" class="nav__dropdown-item">Girls</a>
                                    </div>
                                </div>
                            </div>-->
        ...
        <div class="searchbox__container">
            <form action="adminviewhouse.jsp" method="Post">
        ...
        <div class="viewhouse__edit-or-delete-container">
            <a href="admindeletehousedetail.jsp" class="viewhouse__edit-or-delete"><i class="fas fa-trash-alt" style="padding-right: 10px; "></i> Delete</a>
        </div>
        <div class="viewhouse__container mediaviewhouse__container">
