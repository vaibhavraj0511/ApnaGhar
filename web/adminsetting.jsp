...
<html lang="en">
    ...
    <body>
                ...
                <div>
                    ...
                    <div class="nav__list">
                        <div class="nav__items">
                            ...
                            <a href="adminsetting.jsp" class="nav__link active">
        ...
        <div class="usersetting__wrapper">
            ...
            %>
            <form action="adminsettingcode.jsp" method="POST">
                <div class="usersetting__form">
                    <div class="usersetting__input-field">
                        <label>User Name</label>
                        <input type="text" class="usersetting__input" value="<%=session.getAttribute("adminUserName")%>" name="username" readonly>
                    </div>
                    <div class="usersetting__input-field">
