...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            PreparedStatement ps = con.prepareStatement("select * from addhouse where email=?");
            ps.setString(1, (String)session.getAttribute("getEmail"));
            ResultSet rs = ps.executeQuery();
        %>
        <!--Content-->
        <div class="viewhouse__edit-or-delete-container">
            <a href="myhouseeditordelete.jsp" class="viewhouse__edit-or-delete">Edit or Delete</a>
        </div>
            ...
            <div class="viewhouse__cards">
                ...
                <div class="viewhouse__card">
                    ...
                    <div class="viewhouse__detail">
                        <p class="viewhouse__detail-heading">ID &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<span class="viewhouse__detail-text"> <%=id%></span></p>
