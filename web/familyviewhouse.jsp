...
<html lang="en">
    <head>
        ...
        <title>ApnaGhar.com | Houses for Family</title>
    ...
    <body>
        ...
        <!--<div class="searchbox__container">
            <form action="familyviewhouse.jsp" method="Post">
        ...
        <div class="viewhouse__container">
            <div class="viewhouse__cards">
                <%
                    String searchArea = request.getParameter("searchbar");
                    String searchCity = request.getParameter("searchbar");
                    PreparedStatement ps = con.prepareStatement("select * from addhouse where category=?");
