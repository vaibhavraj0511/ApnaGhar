...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            pst.setString(1, (String)session.getAttribute("getEmail"));
            ResultSet rs = pst.executeQuery();
            if(rs.next()){
                String photo = rs.getString("profileimage");
            ...
            <div class="editprofile__right">
                ...
                <div class="editprofile__btn-center">
                    ...
                    <div class="editprofile__btn-container">
                        ...
                        <form action="UpdateImageUpload" method="POST" enctype="multipart/form-data">
